...
function writePassword() {
    ...
    function generatePassword() {
        ...
        if (quantity == null || quantity == "") {
            alert('Enter the length for your password.');
            generatePassword.reload();
            console.log('PWD LENGTH REJECTED: ' + quantity + ' characters.');
        }
        else if (!/^[0-99b]+$/.test(quantity)) {
            alert('Only numbers are accepted.');
            generatePassword.reload();
            console.log('PWD LENGTH REJECTED: ' + quantity + ' characters.');
        }
        else {
            console.log('PWD LENGTH ACCEPTED: ' + quantity + ' characters.');
        }
        ...
        console.log(input_upp.toUpperCase() + ': Lowercase');
